...

{
    ...
    cModule* masterModule = getSimulation()->getModule(masterOmnetId);
    ...
    cModule* lteNic = masterModule->getSubmodule("lteNic");
    ...
    cModule* macMod = lteNic->getSubmodule("mac");
    ...
    cModule* rlcMod = lteNic->getSubmodule("rlc");
...

    {
...

        {
            ...
            LteRlcUm *masterRlcUm = check_and_cast<LteRlcUm*>(umMod);
