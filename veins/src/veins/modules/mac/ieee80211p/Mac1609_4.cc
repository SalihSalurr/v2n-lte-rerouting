...
const simsignal_t Mac1609_4::sigReceivedSnr   = registerSignal("org_car2x_veins_modules_mac_sigReceivedSnr");
const simsignal_t Mac1609_4::sigReceivedPower = registerSignal("org_car2x_veins_modules_mac_sigReceivedPower");
...
void Mac1609_4::handleBroadcast(Mac80211Pkt* macPkt, DeciderResult80211* res)
{
    ...
    //TODO
    emit(sigReceivedSnr,   res->getSnr());
    emit(sigReceivedPower, res->getRecvPower_dBm());
